        ...
        <div className='relative mt-20 grid grid-cols-1 lg:grid-cols-3 mb-20 pb-20'>
            ...
            border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2'>
                <div className='relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]'>
                    ...
                    <div className={cn(options.color.twBg, "absolute inset-0 left-[3px] top-px right-[3px] bottom-px rounded-[32px]" 
                    )}/>
                </div>
                <Rnd default={{  
                    x: 150,
                ...
                className=' absolute z-20 border-[3px] border-[#D3ECCD]'
                lockAspectRatio
                                        ...
                                        {COLORS.map((color) => (
                                            <Radio
                                                ...
                                                className={({ focus, checked }) =>
                                                    cn(
                                                        'relative -m-0.9 flex cursor-pointer items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2',
                                                        focus || checked ? color.twBorder : 'border-transparent'
                                                    )
                                                }
                                            >
                                                <span
                                                        ...
                                                        <span className='flex flex-col text-sm'>
                                                            ...
                                                            ? <Description as='span' className='text-gray-500'>
                                                                <span className='block sm:inline'>
                                                                    {option.description.slice(0,1).toUpperCase() + option.description.slice(1)}
                                                                </span>
                                                            </Description> 
                                                            : null}
                                                        </span>
